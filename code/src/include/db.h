...
public:
  ...
  void ShowResult() { 
    ...
    std::cout << "READ_TIMES:" << result_->flashresult_->GetReadTimes() << std::endl;
    std::cout << "WRITE_TIMES:" << result_->flashresult_->GetWriteTimes() << std::endl;
    ...
    std::cout << "AVG_READ_SIZE:" << result_->lsmtreeresult_->GetAverageReadSize() << std::endl;
