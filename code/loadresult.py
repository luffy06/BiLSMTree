...
metrics = ['LATENCY', 'READ_TIMES', 'WRITE_TIMES', 'ERASE_TIMES', 'READ_FILES', 
            'READ_SIZE', 'AVG_READ_SIZE', 'EXPECTED_READ', 'WRITE_FILES', 
            'WRITE_SIZE', 'AVG_WRITE_SIZE', 'EXPECTED_WRITE', 'MINOR_COMPACTION', 
            'MINOR_COMPACTION_SIZE', 'AVG_MINOR_COMPACTION_SIZE', 
            'MAJOR_COMPACTION', 'MAJOR_COMPACTION_SIZE', 'AVG_MAJOR_COMPACTION_SIZE', 
